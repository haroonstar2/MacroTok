 ...
 * ------------------------------------------------------------
 * Props:
 *   - activeDay: number (1–31) indicating the selected day
...
export default function Calendar({ activeDay = 1, onPickDay = () => {} }) {
  ...
  /**
   * addMeal:
   *   - Adds a meal for the currently active day if not already defined
  ...
  /**
   * editMeal:
   *   - Renames an existing meal for the active day
  ...
  /**
   * removeMeal:
   *   - Removes a meal from the active day
  ...
  /**
   * dayMeals:
   *   - Convenience reference for meals of the currently active day
   */
  ...
  return (
    <div className="cal-card">
      ...
      {/* ----------------------------------------------------------
          SUMMARY: Text description of meals for the active day
          ---------------------------------------------------------- */}
