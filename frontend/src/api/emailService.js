...
// ─── EmailJS credentials ──────────────────────────────────────────────────────
// SERVICE_ID  → EmailJS dashboard → Email Services → your service
// PUBLIC_KEY  → EmailJS dashboard → Account → API Keys
// Each TEMPLATE_ID → EmailJS dashboard → Email Templates → that template
const SERVICE_ID = 'service_oo1jjfh';
const PUBLIC_KEY = '4M39WgkujJgCa5Cta';

const TEMPLATES = {
  accountCreated:   'template_2q1l0np',
  accountDeactivated: 'YOUR_TEMPLATE_ID_ACCOUNT_DEACTIVATED',
  accountReactivated: 'YOUR_TEMPLATE_ID_ACCOUNT_REACTIVATED',
  passwordReset:    'template_a3evhns',
  accountDeleted:   'YOUR_TEMPLATE_ID_ACCOUNT_DELETED',
};
